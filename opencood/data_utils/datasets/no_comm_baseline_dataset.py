...
"""
Dataset class for the single-agent no-communication baseline.
"""
import random
import math
...
class NoCommBaselineDataset(basedataset.BaseDataset):
    """
    This class keeps the single-agent PointPillars path on the ego vehicle
    without communication rounds.
    """
    def __init__(self, params, visualize, train=True):
        super(NoCommBaselineDataset, self).__init__(params, visualize, train)
    ...
    def collate_batch_test(self, batch):
        ...
        for the no-communication baseline dataset.
        ...
        # For the no-comm baseline, we also stack lidar for better
        # visualization
        if self.visualize:
